...
public class HZMissionStatement {
    ...
    //Compiles an array of the entire mission statement of the HZ
    public HZMissionStatement(String statement1, int numberOfStatements, String statement2, String statement3, String currentOs) {

        //creates a new _firstAmbition object to fill with strings
    ...
    //returns _firstAmbition strings
